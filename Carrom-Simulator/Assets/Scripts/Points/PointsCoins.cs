...
public class PointsCoins : MonoBehaviour
{
    private Rigidbody r;
    private int k = 0;
    ...
    void Update()
    {
        ...
        if ( k != MainPoints.flag && MainPoints.QueenFlag != 0 && Tag == "QueenHoled")
        {
            r.transform.position = new Vector3(0, 3, 0);
            k = 0;
            MainPoints.QueenFlag = 0;
            r.gameObject.tag = "Queen";
        }
        ...
        else if (v.x > -x1 && v.x < -x2 && v.z < z1 && v.z > z2)
        {
            PointLogic();
        }
    ...
    private void PointLogic()
    {
        ...
        if (Tag == "White")
        {
            ...
            {
                MainPoints.QueenFlag = 0;
                MainPoints.MainPointQueenFlag = 1;
    ...
    IEnumerator ExecuteAfterTime(float time)
    {
        ...
        Button NextTurn = yourButton.GetComponent<Button>();
